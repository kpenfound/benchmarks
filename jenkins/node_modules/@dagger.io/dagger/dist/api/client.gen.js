    ...
    export(path, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield computeQuery([
                ...
                {
                    operation: "export",
                    args: Object.assign(Object.assign({ path }, opts), { __metadata: metadata }),
                },
            ], this.client);
            return response;
        });
    ...
    publish(address, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield computeQuery([
                ...
                {
                    operation: "publish",
                    args: Object.assign(Object.assign({ address }, opts), { __metadata: metadata }),
                },
            ], this.client);
            return response;
        });
        ...
        return new Container({
            queryTree: [
                ...this._queryTree,
                {
                    ...
                    args: Object.assign(Object.assign({ port }, opts), { __metadata: metadata }),
                },
            ],
            host: this.clientHost,
            sessionToken: this.sessionToken,
        ...
        return new Container({
            queryTree: [
                ...this._queryTree,
                {
                    ...
                    args: Object.assign(Object.assign({ path, cache }, opts), { __metadata: metadata }),
                },
            ],
            host: this.clientHost,
            sessionToken: this.sessionToken,
